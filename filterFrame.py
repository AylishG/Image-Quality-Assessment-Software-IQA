...
class FilterFrame(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.negative_button = Button(master=self, text="Negative", width=20)
        self.black_white_button = Button(master=self, text="Black White", width=20)
        self.sepia_button = Button(master=self, text="Sepia", width=20)
        self.emboss_button = Button(master=self, text="Emboss", width=20)
        self.gaussian_blur_button = Button(master=self, text="Gaussian Blur", width=20)
        self.median_blur_button = Button(master=self, text="Median Blur", width=20)
        self.noise_reduction_button = Button(
            master=self, text="Noise Reduction", width=20)
        self.quality_detection_button = Button(
            master=self, text="Quality Detection", width=20)
        self.cancel_button = Button(master=self, text="Cancel", width=25, height=2)
        self.apply_button = Button(master=self, text="Apply", width=25, height=2)
    ...
    def quality_detection(self):
        ...
        laplacian_var = cv2.Laplacian(self.filtered_image, cv2.CV_64F).var()    
        if laplacian_var < 5:
